...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('dbio_core_path', null,
                    $modx->getOption('core_path') . 'components/dbio/') . 'model/';
            $modx->addPackage('dbio', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/dbio/model/schema/dbio.mysql.schema.xml';
