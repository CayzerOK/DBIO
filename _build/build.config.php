...
// define package
define('PKG_NAME', 'DBIO');
define('PKG_NAME_LOWER', strtolower(PKG_NAME));

define('PKG_VERSION', '0.0.1');
define('PKG_RELEASE', 'ea');
...
} elseif (file_exists(dirname(dirname(dirname(__FILE__))) . '/www/modx/core')) {
    define('MODX_BASE_PATH', dirname(dirname(dirname(__FILE__))) . '/www/modx/');
} else {
